    ...
    <div className="flex flex-col lg:flex-row items-center flex-wrap my-5">
        ...
        <div className="lg:w-1/2 text-left z-10 max-lg:p-5" id="second_section_a">
            ...
            <div className="flex flex-wrap gap-2 mb-4 ">
                ...
                <Image src={`/images/Star-05.png`} width={25} height={20} alt=''  className='flex justify-center items-center'/>
...
<Image src={`/images/cube-02.png`} width={25} height={20} alt=''  className='flex justify-center items-center'/>
<h3  className="text-lg font-semibold mb-4 pt-3">
    Budgeting Intervals
</h3>
</div>
...
<Image src={`/images/cube-04.png`} width={25} height={20} alt=''  className='flex justify-center items-center'/>
<h3  className="text-lg font-semibold mb-4 pt-3">
    Budgeting Intervals
</h3>
</div>
